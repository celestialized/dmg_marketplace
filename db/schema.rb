...
ActiveRecord::Schema.define(version: 2020_11_02_051481) do
  ...
  create_table "spree_suppliers", id: :serial, force: :cascade do |t|
    ...
    t.index ["admin_id"], name: "index_spree_suppliers_on_admin_id"
    ...
    t.index ["user_id"], name: "index_spree_suppliers_on_user_id"
  end
